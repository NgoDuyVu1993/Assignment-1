...
var checkfileExist_2 = require("../../utilities/checkfileExist");
var processImg = express_1.default.Router();
processImg.get('/', function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, checkfileExist_1.fileExist)('full', FileName)];
            case 1:
                exist = _a.sent();
                if (FileName == null || !exist) {
                    response.status(400).send("The image name ".concat(FileName, " is invalid!"));
                    return [2 /*return*/];
                }
                ...
                return [4 /*yield*/, (0, checkfileExist_1.fileExist)('thumb', "".concat(FileName, "_").concat(Height, "_").concat(Width))];
            case 2:
                // If the file is already exist
                exist = _a.sent();
                if (exist == true) {
                    response.status(200).sendFile((0, checkfileExist_2.filePath)('thumb', "".concat(FileName, "_").concat(Height, "_").concat(Width)));
                    return [2 /*return*/];
                }
